...
public class BinarySearchTree<E extends Comparable<E>>
    ...
    /**
     * BinarySearchTree uzerinde dolasmak icin implement edilen nested iterator
     * class
     *
     * @param <E> generic type
     */
    public static class bstIterator<E> implements Iterator<E> {

        private Stack<Node> bstStack = new Stack<>();

        /**
         * Treenin sol kolu stacke push ediliyor
         *
         * @param root treenin tepe nodu
         */
        ...
        /**
         * hasNext fonksiyonunda stackin bos olup olmamasi kontrol ediliyor
         *
         * @return boolean
         */
        @Override
        ...
        /**
         * sol kolun en altindan yukari cikarken inorder duzende ciktigi kolun
         * right'ina da bakiyor
         *
         * @return node data
         */
        @Override
        public E next() {
            try {
                Node next = bstStack.pop();

                while (next.right != null) {
                    bstStack.push(next.right);
